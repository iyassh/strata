...
| The four log-generic gates run on two public event logs (Sepsis: 1,050 cases / 15,214 events; receipt: 1,434 / 8,577), all pass, 0.8 s each | `gates_public_log.json` (`scripts/gates_public_log.py`; logs fetched by DOI/URL, not committed) |
