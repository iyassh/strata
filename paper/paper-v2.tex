...
Three pre-registered hypotheses were refuted during this work and three of the project's own results were withdrawn (Table~\ref{tab:refuted}). They are reported because a protocol that only confirms is not a protocol, and because these refutations constrain the contribution more usefully than the confirmations do.
...
\hline
\end{tabular}
\caption{Six results that went against the project. Each is reported in full in the text that follows.}
\label{tab:refuted}
\end{table}
