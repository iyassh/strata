...
\title{STRATA: Eight Adverse Results and a Detector\\ \large HVAC fault detection under a falsification protocol}
\author{Yassh Singh \\
...
\hline
\end{tabular}
\caption{Eight results that went against the project. Rows 4 and 5 are reported in Section~\ref{sec:protocol}; the rest in the text that follows.}
\label{tab:refuted}
\end{table}
