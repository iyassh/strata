...
These gates were not designed in advance; each was added after a dataset defect got past the previous set. Three of the five errata in Section~\ref{sec:errata} (E1, E2 and E4) were found by this battery rather than by inspection; E3 was found by auditing our own baseline and E5 by a later hostile audit, which is the argument for running it: the defects are not visible in summary statistics, and every one of them would have inflated a published result.
