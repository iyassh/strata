...
9 & Hypothesis: the discovered model was starved of vocabulary --- healthy-derived actuator and flow band states let the state channels detect within the false-alarm budget. & One missed scenario becomes significant and the single-duct model channel fires on 14 scenarios instead of none, at 7, 14 and 18 false-alarm days in 96; falsifier F-X14.a fired. Alignment-based conformance on the enriched fan-powered logs was computationally impractical and not evaluated (two recorded amendments). & Vocabulary was part of the limit; richer vocabulary buys detections at false alarms the budget forbids. Whether a stricter calibration keeps the gain inside the budget is untested. \\
\hline
\end{tabular}
