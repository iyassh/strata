...
DEPLOYED_FPR_CEILING = {"sdahu": 1 / 96, "pfpu": 8 / 96, "sfpu": 9 / 96, "ddahu": 3 / 96, "fcu": 5 / 96}   # pfpu 7 -> 8 (X33b), sfpu 6 -> 9 (X33c), fcu 4 -> 5 (X33e), 2026-09-25   # pinned counts after X25 (was 1/5/4 on the first three)
